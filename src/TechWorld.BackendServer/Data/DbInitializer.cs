        ...
        public async Task Seed()
        {
            ...
            if (!_context.Products.Any())
            {
                var products = new List<Product>
                {
                    ...
                    new Product(){Name = "Laptop HP Envy 13 ba1030TU i7 1165G7/8GB/512GB/13.3\"FHD/Win 10", Description = "Mua laptop Asus Zenbook UX425EA KI429T i5 là một sự lựa chọn đúng đắn của bạn! Mỏng nhẹ 1,17kg, độ bền quân đội MIL-STD-810G, màn hình full HD đẹp tuyệt mỹ. XEM NGAY!", Content = null, OriginalPrice = 26699000, Price = 28699000, PromotionPrice = 30699000,Quantity = 30, ViewCount = 1, SeoAlias = "dell-g3-15-3500b-i7-10750h", SeoTitle = "Laptop Dell G3 15 3500B i7 10750H chính hãng, trả góp 0% | Fptshop.com.vn", SeoKeyword = "Dell G3 15 3500B i7 10750H/16GB/512GB/15.6", SeoDescription = "Mua laptop Dell G3 15 3500B i7 10750H có sức mạnh đột phá để mang đến trải nghiệm chơi game đỉnh cao. Trả góp 0% xét duyệt nhanh, miễn phí giao hàng, bảo hành chính hãng 1 năm", CreatedDate = DateTime.Now,RateCount = 1, RateTotal = 1, BrandId = 11, CategoryId = 4},
                ...
                var specifications = new List<Specification>
{
                    ...
                    new Specification(){Cpu = "Intel Core i7-10750H", Ram = "16 GB, DDR4, 2933 MHz", Screen="	15.6\", 1920 x 1080 Pixel, WVA, 120 Hz, 250 nits, WVA Anti-glare LED Backlit Narrow Border",Graphic="NVIDIA GeForce GTX 1660Ti 6 GB & Intel UHD Graphics", HardWare="SSD 512 GB", Os="Windows 10", Weight=2.58, Size="364.46 x 254 x 21.60 ~ 30.96", Origin="Trung Quốc",  ReleasedYear=2020, ProductId=9}
